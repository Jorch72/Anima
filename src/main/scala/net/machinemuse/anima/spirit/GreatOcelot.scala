...
import net.machinemuse.anima.spirit.GreatCow._
import net.minecraft.world.World
import net.minecraft.entity.player.EntityPlayer
import net.machinemuse.anima.entity.{EntityGreatOcelot, EntityGreatSpirit, EntityGreatCow}
import net.minecraft.util.{IIcon, ChatComponentText, AxisAlignedBB, MathHelper}
...
object GreatOcelot extends GreatSpirit {
  ...
  def receiveOffering(player: EntityPlayer, entityitem: EntityItem, ocelot: EntityGreatSpirit): Boolean = {
    ...
    if (stack.getItem == Item.itemRegistry.getObject("wheat")) {
      GreatOcelot.addFavour(player, stack.stackSize)
